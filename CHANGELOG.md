...
# Unreleased
### Changed
- Convert the Python classifiers to Fedora SPDX expressions (where possible, based on PEP-0639)
- When `--fedora-compliant` option is set, a check of the converted expressions is performed
to determine license is good for Fedora. Data is provided by the [Fedora Legal team](https://gitlab.com/fedora/legal/fedora-license-data/)
