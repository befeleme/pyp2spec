...
| scripts | entry points read from wheel's dist-info/entry_points.txt (if present) | list of strings |
| top_level_modules | module names read from wheel's dist-info/top_level.txt (if present) | list of strings |
...
%pyproject_save_files -l aionotion
